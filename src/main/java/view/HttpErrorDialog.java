...
public class HttpErrorDialog extends JDialog {

    public HttpErrorDialog(JFrame parent, String message) {
        ...
        title.setForeground(new Color(220, 38, 38));   // 红色强调
        ...
        JButton okBtn = new JButton("OK") {
            ...
            protected void paintComponent(Graphics g) {
                ...
                g2.setColor(new Color(220, 38, 38)); // 红色按钮
